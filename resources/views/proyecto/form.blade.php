<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="descripcion_proyecto" class="form-label">{{ __('Descripcion Proyecto') }}</label>
            <input type="text" name="descripcion_proyecto" class="form-control @error('descripcion_proyecto') is-invalid @enderror" value="{{ old('descripcion_proyecto', $proyecto?->descripcion_proyecto) }}" id="descripcion_proyecto" placeholder="Descripcion Proyecto">
